...
<p align="center">
    A simple Facebook Messenger Bot made by me(ConThoBanSung) and my brother SpermLord.
    <br />
    <br />
...
<br />
<p>
<strong>MiraiProject</strong> thật chất là một dự án mang đến Messenger một trải nghiệm mới cho người dùng bằng cách xây dựng một hệ thống bot dành riêng cho messenger facebook. Dự án này được <strong>ConThoBanSung</strong>(Founder) và <strong>SpermLord</strong>(Co-Founder) xây dựng và duy trì.
</p>
